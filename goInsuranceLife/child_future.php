...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "child_future.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=child_future.php">
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="wow bounceInLeft pol_text1">LIC's Child Future Plan</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:100px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span style="color:whitesmoke;" class="pol_text2"> Ensure  your child's future,fully!!
</span>
                  </div>
                 ...
                 <img src="images/future.jpg"  id="future_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
                 </div>
           <div class="col-md-12 img-responsive">
                 ...
                 <div class="col-md-3" style="margin-top:20px;margin-left:-40px;">
                     <span style="font-size:25px;margin-left:50px;color:background;">Secure your<br>
                         <span style="margin-left:48px;">child's life</span></span><br />
...
This plan is specially designed to meet the increasing educational, marriage and other needs of growing children. It provides the risk cover on the life of child not only during the policy term but also during the extended term (i.e. 7 years after the expiry of policy term). A number of Survival benefits are payable on surviving by the life assured to the end of the specified durations.</div>
    ...
    <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
        On death (after the Date of Commencement of Risk) - Sum Assured along with vested Simple Reversionary Bonuses and Final (Additional) Bonus, if any shall be payable. <br><br>
...
the policy is in full force.
   ...
   <div>
    <span style="font-weight:300;font-size:18px;color:background;">Auto Cover :
     ...
     <button class="btn btn-warning img-responsive  wow fadeInRight quote1" style="margin-left:500px;margin-top:-20px;">Life is priceless, insurance is affordable <span style="font-size:13px;font-weight:200;">Dan Wilcox</span></button>
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
        If after at least two full year’s premiums have been paid, and any subsequent premium be not duly paid, full death cover shall continue for a period of two years from the due date of the First Unpaid Premium (FUP). During this Auto Cover Period, one or more instalments of premiums with interest can be paid without submission of evidence of health. On payment of one or more of the arrears of instalment premiums with interest, the Auto Cover Period of 2 years shall be extended from the due date of new FUP. Premium Waiver Benefit shall remain inforce during the Auto Cover period.</p><br />
   </div>
