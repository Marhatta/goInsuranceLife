...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "single_premium.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=single_premium.php">
...
-->
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left">Here are the full details of the Single Premium Endowment Plan.Click on pdf to get the details.</marquee>    
                 </div>
                ...
                <div class="col-md-3" style="float:right;margin-top:-15px;margin-right:-60px;">
                 ...
                 <a href="https://licindia.in/getattachment/Products/Insurance-Plan/benefits/LICs-Single-Premium-Endowment-Plan-09062016.pdf.aspx">Single&nbsp;Premium&nbsp;Endowment&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="pol_text1 wow bounceInLeft">LIC's Single Premium Endowment Plan</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:120px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                     <span class="pol_text2" style="color:whitesmoke;">Make your move today for your winning tomorrow.</span>
                  </div>
            ...
            -->
               ...
               <div style="margin-right:-60px;">  
                 <img src="images/sing.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
            </div>
           ...
           <div class="col-md-12 img-responsive">
                 ...
                 LIC's Single Premium Endowment Plan is a participating non-linked savings cum protection plan, where premium is paid in lump sum at the outset of the policy. This combination provides financial protection against death during the policy term with the provision of payment of lumpsum at the end of the selected policy term in case of his/her survival. This plan also takes care of liquidity needs through its loan facility.</div>
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">a) On death during the policy term before the date of commencement of risk: Return of single premium excluding service tax and extra premium, if any, without interest.
<br><br>
b) On death during the policy term after the date of commencement of risk: Sum Assured along with vested Simple Reversionary Bonuses and Final Additional Bonus, if any.<br><br>

Where premiums exclude service tax, extra premium and rider premiums, if any.</p><br /></div>
...
<br><br>
Final (Additional) Bonus may also be declared under the policy in the year when the policy results into a claim either by death or maturity on such terms and conditions as may be declared by the Corporation from time to time.</p><br />
   </div>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                       50,000 to 95,000 Nil<br>
1, 00,000 to 1, 95,000  18%o S.A.<br>
2, 00,000 to 2, 95,000  25%o S.A.<br>
