...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "jeevan_lakshya.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=jeevan_lakshya.php">
...
-->
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" class="marquee_text" direction="left">Here are the full details of the Jeevan Lakshya Plan.Click on pdf to get the details.</marquee>    
                 </div>
               ...
               <a href="https://www.licindia.in/getattachment/Products/Insurance-Plan/jeevan-lakshya/LICs-Jeevan-Lakshya-09062016.pdf.aspx">Jeevan&nbsp;Lakshya&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="wow bounceInLeft pol_text1">LIC's Jeevan Lakshya Plan</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:100px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span style="color:black;" class="pol_text2">Give your family a better vision to see the great future.</span>
                  </div>
...
<!--                 <button class="btn btn-success" style="position: absolute;margin-left:40px;margin-top:200px;">Contact us now</button>-->
           ...
           <div style="margin-right:-60px;">      
                 <img src="images/lak.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
            </div>
           <div class="col-md-12 img-responsive">
                ...
                LIC's Jeevan Lakshya is a participating non-linked plan which offers a combination of protection and savings. This plan provides for Annual Income benefit that may help to fulfill the needs of the family, primarily for the benefit of children, in case of unfortunate death of Policyholder any time before maturity and a lump sum amount at the time of maturity irrespective of survival of the Policyholder. This plan also takes care of liquidity needs through its loan facility.</div>
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">On death of the Life Assured before the stipulated Date of Maturity provided the policy is in full force by paying upto-date premiums, Death Benefit, defined as sum of “Sum Assured on Death”, vested Simple Reversionary Bonuses and Final Additional Bonus, if any, shall be payable. Where “Sum Assured on Death” is defined as the sum of:<br>
 Annual Income Benefit equal to 10% of the Basic Sum Assured, which shall be payable from the policy anniversary coinciding with or following the date of death of Life Assured, till the policy anniversary prior to the date of maturity.Assured Absolute Amount equal to 110% of Basic Sum Assured, which shall be payable on due date of maturity; and The vested Simple Reversionary Bonuses and Final Additional Bonus, if any, included in the Death Benefit, shall be payable on due date of maturity.<br><br>

The Death Benefit defined above shall not be less than 105% of all the premiums paid as on date of death.<br><br>

Premiums referred above exclude tax, extra premium and rider premium(s), if any.</p><br /></div>
...
Final Additional Bonus shall not be payable under reduced paid-up policies.
  ...
  <div>
   ...
   <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">The policyholder has an option of availing the following Rider benefit(s):<br><br>

» LIC’s Accidental Death and Disability Benefit Rider (UIN: 512B209V01)<br>
» LIC’s New Term Assurance Rider (UIN: 512B210V01)<br>

Rider Sum Assured cannot exceed the Basic Sum Assured.<br><br>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                         1,00,000 and above (in multiples of Rs. 10,000/-)
                     </td>
                 </tr>
                 <tr>
                     <td>
                 ...
                 <tr>
                     ...
                     <td>
                       1,00,000 to 1,90,000 - Nil<br>
2,00,000 to 4,90,000 - 2%o Basic Sum Assured<br>
