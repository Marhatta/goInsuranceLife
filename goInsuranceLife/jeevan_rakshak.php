...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "jeevan_rakshak.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post"  action="addcontact.php?id=jeevan_rakshak.php">
...
-->
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left">Here are the full details of the Jeevan Rakshak Plan.Click on pdf to get the details.</marquee>    
                 </div>
                ...
                <div class="col-md-3" style="float:right;margin-top:-15px;margin-right:-60px;">
                 ...
                 <a href="https://www.licindia.in/getattachment/Products/Insurance-Plan/jeevan-rakshak/LICs-Jeevan-Rakshak-09062016-(1).pdf.aspx">Jeevan&nbsp;Rakshak&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="pol_text2 wow bounceInLeft">LIC's Jeevan Rakshak Plan</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:100px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                       <span class="pol_text2" style="color:whitesmoke;">Don't leave anything to chance.Protect the ones you love with life insurance.</span>
                  </div>
<!--                 
                 ...
                 <img src="images/rakshak.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
            </div>
           ...
           <div class="col-md-12 img-responsive">
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">In case of death of the policyholder during the policy term provided all due premiums have been paid, “Sum Assured on Death” shall be payable, which is the highest of<br>
» Basic Sum Assured or<br>
» 10 times of annualized premium or<br>
» 105% of all the premiums paid as on date of death.<br>
The premiums defined above exclude service tax, extra premium and Accident Benefit rider premium, if any.<br><br>

In addition to the above, Loyalty Addition, if any shall also be payable if death occurs after completion of 5th policy year.</p><br /></div>
   ...
   <div>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
        Basic Sum Assured, along with Loyalty Addition, if any, shall be payable in lump sum on Survival to the end of the policy term provided all due premiums have been paid.  </p><br />
   </div>
  ...
  <div>
   ...
   <br /><br />  <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">  Accident Benefit Rider is available as an optional rider by payment of additional premium. In case of accidental death, the Accident Benefit Sum Assured will be payable as lumpsum along with the death benefit under the basic plan
                 </p>
  </div>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                       Nil on 75,000 to 1,45,000 <br>
 1.50%o SA to 1,50,000 and above   
                     </td>
                 </tr>
             </tbody>
