...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "bhagya_lakshmi.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=bhagya_lakshmi.php">
...
-->
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left">Here are the full details of the LIC's New Bhagya Lakshmi plan.Click on pdf to get the details.</marquee>    
                 </div>
                ...
                <div class="col-md-3" style="float:right;margin-top:-15px;margin-right:-60px;">
                 ...
                 <a href="https://www.licindia.in/getattachment/Products/Micro-Insurance-Plans/LIC-s-Bhagya-Lakshmi-(UIN-512N292V01)/benefit/LIC-Bhagya-Laxmi-Policy-Doc08072016.pdf.aspx">LIC&nbsp;Bhagya&nbsp;Lakshmi&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="wow bounceInLeft pol_text1">LIC's Bhagya Lakshmi Plan</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:100px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span style="color:whitesmoke;" class="pol_text2">With return of 110% of total amount of premium payable.</span>
                  </div>
                 ...
                 <img src="images/bhagya_lakshmi.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
                 </div>
           <div class="col-md-12 img-responsive">
                 ...
                 <div class="col-md-3" style="margin-top:20px;margin-left:-40px;">
                    ...
                    <a href="jeevan_mangal.php" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;">
                         LIC New Jeevan Mangal Plan</a>
                    <a href="bhagya_lakshmi.php" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;">
                 ...
                 LIC’s Bhagya Lakshmi is a non-par limited payment protection oriented plan with return of 110% of total amount of premiums payable on maturity where the premium paying term is 2 years lesser than the policy term.</div>
    ...
    <span style="font-weight:300;font-size:18px;color:background;">Death Benefit :</span>
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">On Life Assured's death before the stipulated Date of Maturity, provided the policy is in full force by paying up-to-date premiums, “Sum Assured on Death” equal to Sum Assured under the policy shall be payable.</p><br /></div>
   ...
   <div>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
        Provided the policy is inforce, on surviving to the date of maturity, “Sum Assured on Maturity” shall be payable which is equal to 110% of total amount of premiums payable during the term of the contract (excluding taxes and extra premium, if any)</p><br />
   </div>
...
<span style="font-weight:300;font-size:18px;color:background;">  LIC's Bhagya Lakshmi - Salient Features :  </span>

             
                 <img src="images/adobe-logo.jpg" style="width:30px;height:30px;">
                 <a href="https://www.licindia.in/getattachment/Products/Micro-Insurance-Plans/LIC-s-Bhagya-Lakshmi-(UIN-512N292V01)/benefit/LICs_Bhagya_Lakshmi_salient_features-(1).pdf.aspx">LIC&nbsp;Bhagya&nbsp;Lakshmi&nbsp;Salient&nbsp;Features&nbsp;pdf</a>

<br><br>
<span style="font-weight:300;font-size:18px;color:background;"> LIC's Bhagya Lakshmi - Premium Rates :  </span>

             
                 <img src="images/adobe-logo.jpg" style="width:30px;height:30px;">
                 <a href="https://www.licindia.in/getattachment/Products/Micro-Insurance-Plans/LIC-s-Bhagya-Lakshmi-(UIN-512N292V01)/benefit/LICs_Bhagya_Lakshmi_Premium_Rates.pdf.aspx">LIC&nbsp;Bhagya&nbsp;Lakshmi&nbsp;Salient&nbsp;Features&nbsp;pdf</a>

<br><br>
<span style="font-weight:300;font-size:18px;color:background;">  LIC's Bhagya Lakshmi - Proposal Form :  </span>

             
                 <img src="images/adobe-logo.jpg" style="width:30px;height:30px;">
                 <a href="https://www.licindia.in/getattachment/Products/Micro-Insurance-Plans/LIC-s-Bhagya-Lakshmi-(UIN-512N292V01)/benefit/LICs_Bhagya_Lakshmi_Proposal_Form.pdf.aspx">LIC&nbsp;Bhagya&nbsp;Lakshmi&nbsp;Salient&nbsp;Features&nbsp;pdf</a>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                         20,000 to 50,000 ( in multiples of 1000)
                     </td>
                 </tr>
                 <tr>
                     <td>
