...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "limited_endow.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=limited_endow.php">
...
-->
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left">Here are the full details of the Limited Premium Endowment Plan.Click on pdf to get the details.</marquee>    
                 </div>
                ...
                <div class="col-md-3" style="float:right;margin-top:-15px;margin-right:-60px;">
                 ...
                 <a href="https://www.licindia.in/getattachment/Products/Insurance-Plan/limited-endow-benef/LICs-Limited-Premium-Endowment-Plan-09062016.pdf.aspx">Limited&nbsp;Premium&nbsp;Endowment&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="pol_text1 wow bounceInLeft">LIC's Limited Premium Endowment Plan</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:130px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span class="pol_text2" style="color:whitesmoke;">Premium for shot term,Benifits for long term...</span>
                  </div>
           ...
           <!--      
            ...
            -->
             ...
             <div style="margin-right:-60px;">    
                 <img src="images/lim.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
            </div>
           ...
           <div class="col-md-12 img-responsive">
                 ...
                 <div class="col-md-3" style="margin-top:20px;margin-left:-40px;">
                     ...
                     <a href="jeevan_rakshak.php" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;">
                       LIC New jeevan Rakshak
                     </a>
                     
                     <a href="limited_endow.php" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;">
                         LIC Limited Premium Endowment Plan
                     </a>
                     
                      <a href="jeevan_anand.php" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;" >
                         New Jeevan Anand
                     </a>
                     
                     
                       <a href="jeevan_labh.php" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;" >
                       LIC Jeevan Labh
                     </a>
                   <a href="jeevan_pragati.php" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;" >
                        LIC Jeevan Pragati
                     </a>
                   <a href="jeevan_lakshya.php" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;" >
                         New Jeevan Lakshya
                     </a>
...
Final (Additional) Bonus may also be declared under the policy in the year when the policy results into a claim either by death or maturity.</p><br />
  ...
  <div>
   ...
   <br /><br />  <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">  The policyholder has an option of availing the following Rider benefit(s):<br><br>
    (i) LIC’s Accidental Death and Disability Benefit Rider (UIN: 512B209V01)<br>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                         3,00,000 and above (in multiples of Rs. 10,000/-)
                     </td>
                 </tr>
                 <tr>
                     <td>
                 ...
                 <tr>
                     ...
                     <td>
                       3,00,000 to 4,90,000 - Nil<br>
5,00,000 to 9,90,000 - 0.50%o B.S.A.<br>
