...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "bima_diamond.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=bima_diamond.php">
...
<div class="col-md-12">
    ...
    <div class="col-md-12 img-responsive">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left" class="marquee_text">Here are the full details of Bima Diamond plan.Click on pdf to get the details.</marquee>    
                 </div>
                ...
                <div class="col-md-3" style="float:right;margin-top:-15px;margin-right:-60px;">
                 ...
                 <a href="https://www.licindia.in/getattachment/Products/Insurance-Plan/Bima_Diamond/28937-LIC-s-BIMA-DIAMOND-Policy-Document.pdf.aspx">Bima&nbsp;Diamond&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="wow bounceInLeft pol_text1">LIC's Bima Diamond</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:100px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span style="color:whitesmoke;" class="pol_text2">Dazzling six,Happy mix:<br>Maturity value + Risk cover + Loylty additions + Money back + Extended cover + Auto cover</span>
                  </div>
                 ...
                 <img src="images/diamond.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
                 </div>
           <div class="col-md-12 img-responsive">
                 ...
                 <div class="col-md-3" style="margin-top:20px;margin-left:-40px;">
                     ...
                     <a href="money_back20.html" class="btn btn-danger wow fadeInLeft" style="width:280px;">
                         LIC New Money Back Plan-20 years</a>
                  
                     
                     <a href="money_back25.html" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;">
                       LIC New Money Back Plan-25 years
                     </a>
                     
                     <a href="bima_bachat.html" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;">
                         LIC New Bima Bachat Plan
                     </a>
                     
                      <a href="bima_diamond.html" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;" >
                         LIC Bima Diamond
                     </a>
                     
                     
                       <a href="jeevan_tarun.html" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;" >
                       LIC Jeevan Tarun
                     </a>
                 ...
                 LIC’s Bima Diamond plan offers a combination of protection and savings. In case of unfortunate death of the policyholder, this plan provides financial support for the family not only during the policy term but also beyond the policy term during the Extended Cover Period (equal to half of the policy term and beginning from the date of maturity). Periodic payments shall also be made on survival of the policyholder at specified durations during the policy term. <br><br>
               In addition, this plan also takes care of liquidity needs through its Auto Cover as well as loan facility.<br><br>
                  It is a close ended plan which shall be available for sale upto 31st August, 2017, coinciding with the Diamond Jubilee Year of the Corporation.</div>
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
                  i. In case of death of the life assured before the date of maturity:<br><br>

During first five years: “Sum Assured on Death” shall be payable.<br><br>
...
Where “Sum Assured on Death” is defined as the highest of <br>
10 times of annualised premium; or <br>
Sum Assured on Maturity as defined in 1. c) below; or <br>
Absolute amount assured to be paid on death, i.e. Basic Sum Assured.The death benefit shall not be less than 105% of all the premiums paid as on date of death.<br>
Premiums referred above shall not include any taxes, extra amount chargeable under the policy due to underwriting decision and rider premiums, if any.<br><br>

ii. In case of death during the Extended Cover Period: An amount equal to 50% of Basic Sum Assured shall be payable.</p>
   ...
   <div>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
         On the life assured surviving to the end of the policy term, provided all due premiums have been paid, “Sum Assured on Maturity” along with Loyalty Addition, if any, shall be payable.<br>
Where “Sum Assured on Maturity” is as under:<br>
55% of Basic Sum Assured for policy term 16 years<br>
40% of Basic Sum Assured for policy terms 20 and 24 years</p><br />
   </div>
   ...
   <div>
    <span style="font-weight:300;font-size:18px;color:background;"> Survival Benefits :
     ...
     <button class="btn btn-warning img-responsive  wow fadeInRight quote1" style="margin-left:500px;margin-top:-20px;">Life is priceless, insurance is affordable <span style="font-size:13px;font-weight:200;">Dan Wilcox</span></button>
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
         On the life assured surviving to the end of each of the specified durations during the policy term, provided all due premiums have been paid, a fixed percentage of Basic Sum Assured shall be payable. The fixed percentage for various policy terms is as below:<br>
For policy term 16 years:<br>
15% of Basic Sum Assured at the end of each of 4th, 8th and 12th policy year.<br>
For policy term 20 years:<br>
15% of Basic Sum Assured at the end of each of 4th, 8th, 12th and 16th policy year.<br>
For policy term 24 years:<br>
12% of Basic Sum Assured at the end of each of 4th, 8th, 12th, 16th and 20th policy year.</p><br />
   </div>
...
In addition, Loyalty Addition, if any, shall also be considered in Special Surrender Value calculation on surrender of policy during the policy term provided all the premiums for the entire premium paying term have been paid</p><br />
   </div>
                     

        <span style="font-weight:300;font-size:18px;color:background;">Optional Benefit:
         <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span>
          <button class="btn btn-warning img-responsive  wow fadeInRight quote2" style="margin-left:500px;margin-top:-20px;">Life happens so get life insurance  <span style="font-size:13px;font-weight:200;">Brittany LaRoche</span></button><br><br>
 
 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">The policyholder has an option of availing following Rider benefit(s): a) LIC’s Accidental Death and Disability Benefit Rider (UIN: 512B209V01). b) LIC’s New Term Assurance Rider (UIN: 512B210V01) Rider sum assured cannot exceed the Basic Sum Assured. For more details on the above riders, refer to the rider brochure or contact LIC’s nearest Branch Office. </p>
  </div>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                         1,00,000 to 5,00,000( in multiples of 5000)
                     </td>
                 </tr>
                 <tr>
                     <td>
                 ...
                 <tr>
                     ...
                     <td>
                         For inforce policies – upto 90%<br>
For paid-up policies – upto 80%  (percentage of surrender value )
                     </td>
                 </tr>
                 <tr>
                     <td>
                 ...
                 <tr>
                     ...
                     <td>
                        1,00,000 to 1,80,000 - Nil<br>
2,00,000 to 4,80,000 - 2.5 ‰ BSA<br>
5,00,000 - 3 ‰ BSA
                     </td>
                 </tr>
             </tbody>
