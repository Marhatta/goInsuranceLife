...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "new_endow.php";';
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p style="color:red">* Mandotary Fields</p>
                 <form method="post" action="addcontact.php?id=new_endow.php" enctype="">
...
-->
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left">Here are the full details of the New Endowment Plan.Click on pdf to get the details.</marquee>    
                 </div>
                ...
                <div class="col-md-3" style="float:right;margin-top:-15px;margin-right:-60px;">
                 ...
                 <a href="https://www.licindia.in/getattachment/Products/Insurance-Plan/n-endowment/LICs-New-Endowment-Plan_09062016.pdf.aspx">New&nbsp;Endowment&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="pol_text1 wow bounceInLeft">LIC's New Endowment Plan</span>
...
<!--                 
    ...
    -->        
                 ...
                 <img src="images/polslider2.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
            </div>
           ...
           <div class="col-md-12 img-responsive">
                 ...
                 LIC's New Endowment Plan is a participating non-linked plan which offers an attractive combination of protection and saving features. This combination provides financial support for the family of the deceased policyholder any time before maturity and good lump sum amount at the time of maturity for the surviving policyholders. This plan also takes care of liquidity needs through its loan facility.</div>
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">In case of death during the policy term provided all due premiums have been paid Death benefit, defined as sum of "Sum Assured on Death" and vested Simple Reversionary Bonuses and Final Additional bonus, if any, shall be payable. Where, “Sum Assured on Death” is defined as higher of Basic Sum Assured or 10 times of annualised premium. This death benefit shall not be less than 105% of all the premiums paid as on date of death.<br><br>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                        0% on 0 to 1,95,000 of Sum Assured <br>
2% on 2,00,000 to 4,95,000 of Sum Assured<br>
