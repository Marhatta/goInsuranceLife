...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "group_gratuity.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=group_gratuity.php">
    ...
    <div class="col-md-2">
     ...
     <div class="col-md-12 img-responsive">
           ...
           <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left" class="marquee_text">Here are the full details of the New Group Gratuity Cash Accumulation  Plan.Click on pdf to get the details.</marquee>    
                 </div>
               ...
               <a href="https://www.licindia.in/Group-Schemes/Group-Scheme/LICs_New_GGCA">Group&nbsp;Gratuity&nbsp;Cash&nbsp;Accumulation&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="wow bounceInLeft pol_text1">LIC's New Group Gratuity Cash Accumulation Plan</span>
                 ...
                 <img src="images/gratuity_cash_accumulation.png"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
           ...
           <div class="col-md-12 img-responsive">
                ...
                LIC’s New Group Gratuity Cash Accumulation Plan is a non–linked non-participating, fund
based Variable Insurance Product.. This plan helps to meet the employer’s obligation for
statutory Gratuity Benefit to their employees. The plan also offers Life Cover Benefit so
that in case of death of a group member an amount equal to sum assured in respect of
that member will be paid. The amount of life cover in respect of each member shall be
guided by the scheme rules of the employer’s</div>
...
<div>
              ...
              <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">  Each policy year a Policyholder shall pay Contributions to secure Gratuity Benefit as per
Scheme Rules and also to provide Life Cover Benefit.<br><br>
The Contributions received under the scheme may include Contributions towards the past
service liability and the Contributions in respect of that year. The employer/trustees may
pay the Contributions at any time during the year.<br><br>
All the Contributions paid by employer/ trustees will be credited to the Policy Account
maintained in the name of employer/trustees
          </div>     
...
<div>
              ...
              <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight"> A single Policy Account shall be maintained in respect of all Contributions received from
policyholder.<br><br>
For a new scheme, a Policy Account will be created in respect of a scheme as soon as the Policyholder
pays the first Contribution. The Policyholder’s Account shall be credited with interest amount by
providing the following types of interest rates:<br><br>

                <strong>Minimum Floor Rate (MFR):</strong> MFR is a guaranteed interest rate that Policy Account
shall earn during the entire policy term. This plan offers a Minimum Floor Rate (MFR) of
0.5% p.a.
<br>
<strong>Additional Interest Rate (AIR):</strong>  In addition to MFR, the Corporation shall also declare
a non zero-positive Additional Interest Rate (AIR) at the beginning of each financial
quarter on the Policy Account. This AIR shall remain guaranteed for that quarter.
<br><br>
<strong>Residual Addition (RA):</strong>  Starting from the fifth policy anniversary, in addition to MFR
and AIR, the Corporation may also declare a non zero- positive Residual Addition (RA)
on Policy Account at the end of each policy year.
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
                  <strong>a) Benefits payable on death of a member while in service:</strong> The benefit payable will
be equal to the sum of following:<br><br>
i) Sum assured and<br>
ii) Gratuity Benefit as per the scheme rules.<br><br>
<strong>b) Benefits payable on retirement / leaving service before Retirement:</strong>
 The
Gratuity Benefits shall be payable as specified in the scheme rules.
   ...
   <div>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
        Mortality Charge is the amount required to secure the Life Cover
Benefits to the members from year to year as per scheme rules. Mortality Charges will
be deducted from Policy Account Value on monthly basis in advance.<br><br>
The total Mortality Charge to be deducted from Policy Account Value shall be the sum
of Mortality Charges in respect of each member covered under the policy.<br><br>
The Mortality Charge Table to be applied to a group will depend on the size, mortality
experience and risk profile including occupation of the group.</p><br /><br>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
         The Policy Administration Charge per year shall be
Rs. 0.15 per Rs.1000/- of total Life Cover Benefit under the policy at the time of
deduction of the charge. This charge will be a deducted from Policy Account on
monthly basis in advance.</p><br />
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
           A Market Value Adjustment (MVA) will be applicable on
Bulk Exits and complete surrender of the policy. The MVA will be applicable on
withdrawal amount which is over and above 25% of the Policy Account Value. The MVA
amount shall be derived at the time of exit using the following formula.<br><br>
MVA amount = [Maximum (0, Policy Account Value – Market Value) / Policy Account
Value] * (Net amount which is over and above the amount representing Bulk Exit)<br><br>
Where, Market Value is derived from the revaluation of assets at the time when MVA is
carried out. The assets will be earmarked separately for this product. The MVA amount,
if any, will be deducted from the Policy Account Value.
</p><br />
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
         If the policy is surrendered within three policy years from the
date of commencement, the surrender charge shall be 0.05% of the Policy Account
Value subject to maximum of Rs.500,000/-.<br><br>
No surrender charge will be levied if a policy is surrendered after completion of third
policy anniversary.</p><br />
