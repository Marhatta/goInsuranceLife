            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post">
                  ...
                  <textarea cols="50" type="text" id="user_comment" class="form-control" placeholder="Enter Your Query Here..."></textarea><p style="color:red">*</p>
...
<div id="google_translate_element" style="float:right;margin-top:13px;"></div>
 ...
 <body>
    ...
    <div class="col-md-2">
     ...
     <div class="col-md-12" >
          <button style="font-size:25px;font-weight:200;margin-top:20px;margin-bottom: 20px;" class="col-md-12 btn btn-success">About Us</button>
      </div>
      <div class="col-md-12">
    ...
    <script>
      function initMap() {
        var uluru = {lat:28.6281, lng: 77.4397};
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAtkOOxBNBFqrnRxqHbh13agzuGcNbS2nE&callback=initMap">
    </script>
         ...
         <div class="col-md-12" style="text-align:center;">
             <div class="col-md-8" style="margin-top:20px;">
              <span style="font-size:30px;font-weight:300;margin-top:30px">We are available at</span>
              <div style="font-size:20px;font-weight:200;margin-top:20px;" class="wow fadeInUp">
                 <i class="fa fa-address-book"></i>
                  Nimbus 604,Paramount Symphony,Crossing Republic,Ghaziabad,201016
              </div>
              
              <div style="font-size:18px;font-weight:200;margin-top:20px;" class="wow fadeInUp">
              	<i class="fa fa-address-book"></i>
              H no. 40,Sector 1,Vinayak Nagar,Muthi,Jammu,181205</div>
        
         
        
        
             <div style="font-size:30px;font-weight:300;margin-top:30px;">
                <button class="btn btn-primary"> <i class="fa fa-eye"></i> Our Vision</button></div>
                <div style="background-color: black;color:whitesmoke;margin-top:10px;height:100px;" class="wow fadeInUp">
                 <ul>
                 <li>A trans-nationally competitive financial conglomerate of significance to societies and Pride of India</li>
                
                 <li>To be the preferred life insurer of the people by providing innovative life insurance products and world class service at affordable rates.</li>
                 </ul>
                 </div>
             ...
             <div style="font-size:30px;font-weight:300;margin-top:30px;">
                 <button class="btn btn-primary"> <i class="fa fa-bullseye"></i> Our Mission</button></div>

                 <div style="background-color: black;color:whitesmoke;margin-top:10px;" class="wow fadeInUp">
                 <ul>
                 <li>Ensure and enhance the quality of life of people through financial security by providing products and services of aspired attributes with competitive returns, and by rendering resources for economic development.</li>
                
                 <li>To explore and enhance the quality of life of people through financial security by providing professional, healthy and ethical support.".</li>
                 </ul>
                 </div>
             ...
             <div class="col-md-4" style="margin-top:20px;">
                 <span style="font-size:20px;font-weight:200;">Mail us at</span> <br />
                
                     <button class="fa fa-envelope wow swing btn btn-success" style="font-size:40px;" data-wow-iteration="infinite"></button> 
                      <div style="font-size:20px;font-weight:300;">vinod.bhat87@gmail.com</div>
                     <div style="margin-top:20px;">
                         <div style="font-size:20px;font-weight:200;">Contact no.</div>
                       
                         <button class="fa fa-phone wow swing btn btn-danger" style="font-size:40px;" data-wow-iteration="infinite"></button>
                               <div style="font-size:20px;font-weight:300;">1234567890</div>
                     </div>
                 
                 <div style="margin-top:20px;">
                     <button class="btn btn-success"><a href="contact.html" data-toggle="modal" data-target="#myModal">Contact us here</a></button>
                 </div>
             </div>
          </div>
