...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "jeevan_labh.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=jeevan_labh.php">
    ...
    <div class="col-md-2">
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left"class="carousal-text  ">Here are the full details of the Jeevan Labh Plan.Click on pdf to get the details.</marquee>    
                 </div>
               ...
               <a href="https://www.licindia.in/getattachment/Products/Insurance-Plan/Jeevan-Labh/Jeevan_Labh_Policy_document_16022016.pdf.aspx">Jeevan&nbsp;Labh&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="wow bounceInLeft pol_text1">LIC's Jeevan Labh Plan</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:120px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                       <span style="color:whitesmoke;" class="pol_text">Premium stops,Benifits go on...</span>
                  </div>
                 ...
                 <img src="images/slider1.jpg"  id="endow_image" class="img-responsive pol_image" style="width:100%;height:420px;margin-left:-30px;">
                 </div>
           <div class="col-md-12 img-responsive">
                ...
                LIC's Jeevan Labh is a limited premium paying, non-linked, with-profits endowment plan which offers a combination of protection and savings. This plan provides financial support for the family in case of unfortunate death of the policyholder any time before maturity and a lump sum amount at the time of maturity for the surviving policyholder. This plan also takes care of liquidity needs through its loan facility.</div>
                  ...
                  <div style="margin-top:20px;">  <span style="font-weight:300;font-size:20px;color:background;"> Benefits :
                       ...
                       <button class="btn btn-warning img-responsive wow fadeInRight" style="margin-left:400px;" >Live,love,leave well<span style="font-size:13px;font-weight:200;"> &nbsp;Mario&nbsp;Alban&nbsp;Santos</span></button></span><br /><br />
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">In case of death during the policy term, provided all due premiums have been paid, Death benefit, defined as sum of "Sum Assured on Death",vested Simple Reversionary Bonuses and Final Additional bonus, if any, shall be payable. Where, "Sum Assured on Death" is defined as the higher of 10 times of annualised premium or Absolute amount assured to be paid on death i.e. Basic Sum Assured . This death benefit shall not be less than 105% of all the premiums paid as on date of death.<br>
Premiums referred above shall not include any taxes, extra amount chargeable under the policy due to underwriting decision and rider premium(s), if any.</p><br /></div>
   ...
   <div>
    <span style="font-weight:300;font-size:18px;color:background;"> Maturity Benefit :
     ...
     <button class="btn btn-warning img-responsive  wow fadeInRight" style="margin-left:500px;margin-top:-20px;">Life is priceless, insurance is affordable <span style="font-size:13px;font-weight:200;">Dan Wilcox</span></button>
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
        "Sum Assured on Maturity" equal to Basic Sum Assured, along with vested Simple Reversionary bonuses and Final Additional bonus, if any, shall be payable in lump sum on survival to the end of the policy term provided all due premiums have been paid.</p><br />
   </div>
   ...
   <div>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
        The policy shall participate in profits of the Corporation and shall be entitled to receive Simple Reversionary Bonuses declared as per the experience of the Corporation, provided the policy is in full force.<br>
Final (Additional) Bonus may also be declared under the policy in the year when the policy results into a claim either by death or maturity.</p><br />
  ...
  <div>
   ...
   <br /><br />  <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">The policyholder has an option of availing the following Rider benefit(s):<br><br>
    (i) LIC's Accidental Death and Disability Benefit Rider (UIN: 512B209V01)<br><br>
    (ii) LIC's New Term Assurance Rider (UIN: 512B210V01)Rider sum assured cannot exceed the basic sum assured.
                 </p>
  </div>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 <tr>
                     ...
                     <td>
                         8 to [59] years (nearest birthday) for Policy Term 16 years<br>
                                           [54] years (nearest birthday) for Policy Term 21 years <br>
                 ...
                 <tr>
                     ...
                     <td>
                         2,00,000 and above (in multiples of Rs. 10,000/-)
                     </td>
                 </tr>
                 <tr>
                     <td>
                 ...
                 <tr>
                     ...
                     <td>
                       2,00,000 to 4,90,000 Nil<br>
5,00,000 to 9,90,000 1.25%o B.S.A.<br>
10,00,000 to 14,90,000 1.50%o B.S.A.<br>
