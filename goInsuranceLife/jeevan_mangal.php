...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "jeevan_mangal.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=jeevan_mangal.php">
...
-->
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300; " class="wow bounceInLeft">
                     <span class="pol_text1" style="color:whitesmoke;" class="wow bounceInLeft">LIC's New Jeevan Mangal Plan</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:130px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span class="pol_text2" style="color:whitesmoke;">Helping your plan for tomorrow.. <br>Today..</span>
                  </div>
  ...
  <!--               
                 ...
                 <img src="images/jeevan_mangal.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
            </div>
           <div class="col-md-12 img-responsive">
                 ...
                 <div class="col-md-3" style="margin-top:20px;margin-left:-40px;">
                     ...
                     <a href="jeevan_mangal.html" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;">
                         LIC New Jeevan Mangal Plan</a>
					<a href="bhagya_lakshmi.html" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;">
                          LIC Bhagya Lakshmi Plan</a>
                 ...
                 LIC’s Jeevan Mangal is a term assurance plan with return of premiums on maturity, where you may pay the premiums either in lump sum or regularly at Yearly, Half Yearly, Quarterly, Monthly, fortnightly or weekly intervals over the term of the policy.</div>
                   ...
                   <span style="font-weight:300;font-size:18px;color:background;"> Death Benefit : 
                        <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span>
          
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">On death during the term of the policy the Sum Assured under the basic plan is payable, provided the policy is kept in force.</p><br /></div>
   ...
   <div>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
        On surviving to the date of maturity, an amount equal to the total amount of premium paid during the term of the contract excluding the accident benefit premium and all extra premium, if any, is payable ,provided the policy is kept in force.</p><br />
   </div>
  ...
  <div>
     ...
     <span style="font-size:18px;font-weight:300;color:background;">LICs Accidental Death and Disability Benefit Rider:
     <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span>
   <br /><br />  <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">On death arising as a result of accident during the term of the policy, an additional amount, equal to Accident Benefit Rider Sum Assured is payable .<br><br>

On total and permanent disability arising due to accident (within 180 days from the date of accident), the Accident Benefit will be payable in monthly instalments spread over 10 years. If the policy becomes a claim either by way of death or maturity before the expiry of the said period of 10 years, the disability benefit instalments which have not fallen due will be paid along with the claim.<br><br>

The disability due to accident should be total and such that the Life Assured is unable to carry out any work to earn the living. Following disabilities due to accidents are covered:<br>
...
d) amputation of one hand at or above the wrist and one foot at or above the ankle<br><br>

The future premiums shall be waived after the disability claim is admitted.</p>
   ...
   <div>
        ...
        <span style="font-weight:300;font-size:20px;color:background;"> Exclusions :
         <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span>
          <button class="btn btn-warning img-responsive quote2 wow fadeInRight" style="margin-left:500px;margin-top:-20px;">Life happens so get life insurance  <span style="font-size:13px;font-weight:200;">Brittany LaRoche</span></button>
 
     <span style="font-size:18px;font-weight:300;color:background;">Suicide :
        <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span>
   <br /><br />  <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">If the Life Assured commits suicide (whether sane or insane at that time) at any time on or after the date on which the risk under the policy has commenced but before the expiry of one year from the date of commencement of risk under this policy, the sum assured under this policy shall not be payable, instead all the premiums paid under this policy shall be refunded in such cases.</p>

    <span style="font-size:18px;font-weight:300;color:background;">Accident Benefit :
        <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span>
   <br /><br />  <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
The Corporation shall not pay the accidental benefit in case accidental death/ disability arises due to following reasons:<br>
(i) intentional self injury, attempted suicide, insanity or immorality or whilst the Life Assured is under the influence of intoxicating liquor, drug or narcotic; or<br>
(ii) injuries resulting from riots, civil commotion, rebellion, war (whether war be declared or not), invasion, hunting, mountaineering, steeple chasing or racing of any kind; or<br>
(iii) result from the Life Assured committing any breach of law; or<br>
(iv) arises from employment of the Life Assured in the armed forces or military service of any country at war (whether war be declared or not) or from being engaged in police duty in any military, naval or police organization; or<br>
(v) occur after 180 days from the date of accident of the Life Assured.<br>
</p>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                        Yearly, Half-Yearly, Quarterly, Monthly, Fortnightly, and Weekly.
                     </td>
                 </tr>
                 <tr>
                     <td>
                 ...
                 <tr>
                     ...
                     <td>
                         30,000 to 50,000 (in multiples of 10,000)
                     </td>
                 </tr>
