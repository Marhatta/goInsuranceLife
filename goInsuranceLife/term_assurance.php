...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "term_assurance.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=term_assurance.php">
...
<div class="col-md-12">
    ...
    <div class="col-md-2">
     ...
     <div class="col-md-12 img-responsive">
               ...
               <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left" class="marquee_text">Here are the full details of the New Term Assurance Rider.Click on pdf to get the details.</marquee>    
                 </div>
                ...
                <div class="col-md-3" style="float:right;margin-top:-15px;margin-right:-60px;">
                 ...
                 <a href="https://www.licindia.in/getattachment/Products/LIC-s-NEW-TERM-ASSURANCE-RIDER-(UIN-512B210V01)/ASSURNCE_RIDER_Policy_Doc.pdf.aspx">New&nbsp;Term&nbsp;Assurance&nbsp;Rider&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="wow bounceInLeft pol_text1">LIC's E-term</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:100px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span style="color:whitesmoke;" class="pol_text2">Because your happiness lies in the prosperity of your family</span>
                  </div>
                 ...
                 <img src="images/security.png"  id="security_image" class="img-responsive pol_image" style="width:100%;height:420px;margin-left:-30px;">
                 </div>
           <div class="col-md-12 img-responsive">
                 ...
                 <div class="col-md-3" style="margin-top:20px;margin-left:-40px;">
                     ...
                     <a href="anmol_jeevan.html" class="btn btn-danger wow fadeInLeft" style="width:280px;">
                         LIC Anmol Jeevan II</a>
                  
                     
                     
                     <a href="amulya_jeevan.html" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;">
                       LIC Amulya Jeevan II</a>
                     
                     
                     <a href="term_assurance.html" class="btn btn-danger wow fadeInLeft" style="margin-top:10px;width:280px;">
        ...
        <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">In case of unfortunate death of the life assured during the term of the Rider, an amount equal to the Term Assurance Rider Sum Assured shall be payable.</p><br /></div>
   ...
   <div>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
       On survival to the end of the term of the Rider, nothing shall be payable.</p><br />
   </div>
