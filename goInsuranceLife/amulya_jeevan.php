...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "amulya_jeevan.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=amulya_jeevan.php">
...
<div class="col-md-12">
    ...
    <div class="col-md-2">
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12 img-responsive" style="margin-top:30px;">
                  
                 <div class="col-md-9 img-responsive">
                     <marquee style="color:#999999;font-size:18px;" direction="left" class="marquee_text">Here are the full details of the Amulya Jeevan II.Click on pdf to get the details.</marquee>    
                 </div>
                 
                <div class="col-md-3 img-responsive" style="float:right;margin-top:-15px;margin-right:-60px;">
             
                 <img src="images/adobe-logo.jpg" style="width:30px;height:30px;">
                 <a href="https://www.licindia.in/getattachment/Products/Insurance-Plan/LIC-s-Amulya-Jeevan-II/LICs-Amulya_Jeevan-2-09062016.pdf.aspx" style="margin-right:20px;" >Amulya&nbsp;Jeevan&nbsp;II</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="wow bounceInLeft pol_text1">LIC's Amulya Jeevan II</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:100px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span style="color:whitesmoke;" class="pol_text2">Don't leave anything to chance.Protect the ones you love with life insurance.</span>
                  </div>
                 ...
                 <img src="images/amulya_jeevan.jpg"  id="endow_image" class="img-responsive pol_image2" style="width:1300px;height:420px;">
  ...
  <div style="margin-top:30px;">
                 ...
                 LIC's Amulya Jeevan - II is a protection plan which provides financial protection to the insured's family in case of his/her unfortunate demise.</div>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                         25,00,000 and above ( in multiples of 1,00,000)
                     </td>
                 </tr>
