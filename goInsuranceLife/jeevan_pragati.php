...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "jeevan_pragati.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=jeevan_pragati.php">
...
-->
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left">Here are the full details of the Jeevan Pragati Plan.Click on pdf to get the details.</marquee>    
                 </div>
               ...
               <a href="https://www.licindia.in/getattachment/Products/Insurance-Plan/LIC-s-Jeevan-Pragati/LIC_Jeevan_Document_05022016.pdf.aspx">Jeevan&nbsp;Pragati&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="pol_text1 wow bounceInLeft">LIC's Jeevan Pragati Plan</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:120px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span class="pol_text2" style="color:whitesmoke;">A unique protection & savings plan which offer an automatic increase in risk cover after every 5 years during the term of the policy.</span>
                  </div>
  ...
  -->          
                 ...
                 <img src="images/Progress.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
            </div>
           <div class="col-md-12 img-responsive">
                ...
                LIC's Jeevan Pragati Plan is a non-linked, with - profits plan which offers a combination of protection and savings. This plan provides for automatic increase in risk cover after every five years during the term of the policy. In addition, this plan also takes care of liquidity needs through loan facility.</div>
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">In case of death during the policy term, provided all due premiums have been paid, Death benefit, defined as sum of "Sum Assured on Death ", vested Simple Reversionary Bonuses and Final Additional bonus, if any, shall be payable. Where "Sum Assured on Death" is defined as the higher of 10 times of annualised premium or Absolute amount assured to be paid on death i.e. 100% of the Basic Sum Assured during first 5 policy years, 125% of the Basic Sum Assured during 6th to 10th policy years, 150% of the Basic Sum Assured during 11th to 15 th policy years and thereafter 200% of the Basic Sum Assured.<br><br>

This death benefit shall not be less than 105% of all the premiums paid as on date of death.<br><br>

Premiums referred above shall not include any taxes, extra amount chargeable under the policy due to underwriting decision and rider premium, if any.</p><br /></div>
...
Final Additional Bonus may also be declared under the policy in the year when the policy results into a claim either by death or maturity.
  ...
  <div>
   ...
   <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">The policyholder has an option of availing LIC's Accidental Death and Disability Benefit Rider (UIN: 512B209V01). Rider sum assured cannot exceed the Basic Sum Assured.
                 </p>
  </div>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                         1,50,000 and above (in multiples of Rs. 10,000/-)
                     </td>
                 </tr>
                 <tr>
                     <td>
                 ...
                 <tr>
                     ...
                     <td>
                       1,50,000 to 2,90,000 - Nil<br>
                       3,00,000 to 4,90,000 - 1.50 % B.S.A.<br>
                       5,00,000 to 9,90,000 - 2.00 % B.S.A.<br>
