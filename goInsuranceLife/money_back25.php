...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "money_back25.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post"  action="addcontact.php?id=money_back25.php">
...
-->
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left">Here are the full details of New money back plan-25 years.Click on pdf to get the details.</marquee>    
                 </div>
                ...
                <div class="col-md-3" style="float:right;margin-top:-15px;margin-right:-60px;">
                 ...
                 <a href="https://www.licindia.in/getattachment/Products/Insurance-Plan/LIC-s-NEW-MONEY-BACK-PLAN-25-YEARS/LIC-s-25-yrs-MB-Low-file.pdf.aspx">New&nbsp;Money&nbsp;Back&nbsp;Plan-25-Years&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:rgb(59, 89, 152);" class="pol_text1 wow bounceInLeft">LIC New Money Back Plan-25Years</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:120px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span class="pol_text2" style="color:black;">It's going to be hard,but hard is not impossible.</span>
                  </div>
 ...
 <!--                
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:170px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1.5s">
                      <span style="color:black;">We are here to guide you</span>
                  </div>
     ...
     -->       
             ...
             <div style="margin-right:-60px;">
                 ...
                 <img src="images/unit1.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
           ...
           <div class="col-md-12 img-responsive">
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">On death during the policy term provided the policy is in full force, death benefit, defined as sum of “Sum Assured on Death” and vested Simple Reversionary Bonuses and Final Additional Bonus, if any, shall be payable. Where, “Sum Assured on Death” is defined as higher of 125% of the Basic Sum Assured or 10 times of annualized premium. This death benefit shall not be less than 105% of the total premiums paid as on date of death.<br><br>

The premiums mentioned above exclude tax, extra premium and rider premium, if any.</p>
   ...
   <div>
    <span style="font-weight:300;font-size:18px;color:background;"> Survival Benefits :
     ...
     <button class="btn btn-warning img-responsive quote2 wow fadeInRight" style="margin-left:500px;margin-top:-20px;">Life is priceless, insurance is affordable <span style="font-size:13px;font-weight:200;">Dan Wilcox</span></button>
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
         In case of Life Assured surviving to the end of the specified durations 15% of the Basic Sum Assured at the end of each of 5th, 10th, 15th & 20th policy year.</p><br />
   </div>

   <div>
    <span style="font-weight:300;font-size:18px;color:background;"> Participation in Profits :
     <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span>
     <button class="btn btn-warning img-responsive quote2 wow fadeInRight" style="margin-left:500px;margin-top:-20px;">Life is priceless, insurance is affordable <span style="font-size:13px;font-weight:200;">Dan Wilcox</span></button><br>
...
However, on surrender of an inforce basic policy (which has acquired Surrender Value) to which this rider is attached, a proportion of additional premium charged in respect of cover after premium paying term shall be refunded.</p>
  </div>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                        0% on 1,00,000 to 1,95,000 of Sum Assured 
