...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "bima_bachat.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=bima_bachat.php">
...
-->
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left" class="marquee_text">Here are the full details of New Bima bachat plan.Click on pdf to get the details.</marquee>    
                 </div>
                ...
                <div class="col-md-3" style="float:right;margin-top:-15px;margin-right:-60px;">
                 ...
                 <a href="https://www.licindia.in/getattachment/Products/Insurance-Plan/LIC-s-NEW-BIMA-BACHAT/LICs-New-Bima-Bachat-09062016.pdf.aspx">New&nbsp;Bima&nbsp;Bachat&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:rgb(59, 89, 152);" class="wow bounceInLeft pol_text1">LIC New Money Bima Bachat Plan</span>
                   
                 
                 </div>
                 
                 
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:110px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span style="color:black;" class="pol_text2">Save for tomorrow..Not only for you also for your loved ones..</span>
                  </div>
                 ...
                 <img src="images/bachat.jpg"  id="endow_image" class="img-responsive pol_image" style="width:100%;height:420px;margin-left:-30px;">
                 </div>
           <div class="col-md-12 img-responsive">
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">On death during the first five policy years: Sum Assured.<br>
On death after completion of five policy years: Sum Assured along with Loyalty Addition, if any.</p>
   ...
   <div>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
         Payment of Single Premium (excluding taxes and extra premium, if any) along with Loyalty Addition, if any, in case of Life Assured surviving to the end of the policy term.</p><br />
   </div>
   ...
   <div>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
         Payable as given below in case of Life Assured surviving to the end of the specified durations:<br>
<strong>For policy term 9 years:</strong> 15% of the Sum Assured at the end of each of 3rd & 6th policy year<br>
<strong>For policy term 12 years:</strong> 15% of the Sum Assured at the end of each of 3rd, 6th & 9th policy year<br>
<strong>For policy term 15 years:</strong> 15% of the Sum Assured at the end of each of 3rd, 6th, 9th & 12th policy year</p><br />
   </div>

   <div>
    <span style="font-weight:300;font-size:18px;color:background;"> Loyalty Addition :
     <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span>
     <button class="btn btn-warning img-responsive  wow fadeInRight quote2" style="margin-left:500px;margin-top:-20px;">Life is priceless, insurance is affordable <span style="font-size:13px;font-weight:200;">Dan Wilcox</span></button><br>
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight">
         Depending upon the Corporation's experience the policies shall be participate in the profits and shall be eligible for Loyalty Addition. The Loyalty Addition, if any, is payable on death after completion of five policy years and on policyholder surviving to maturity, at such rate and on such terms as may be declared by the Corporation.</p><br />
   </div>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                         35,000 and above ( in multiples of 5000)
                     </td>
                 </tr>
                 ...
                 <tr>
                     ...
                     <td>
                        Equal to 60% of the surrender value
                     </td>
                 </tr>
                 ...
                 <tr>
                     ...
                     <td>
                        First year: 70% of the Single premium excluding taxes and extra premium, if any.<br> Thereafter: 90% of the Single premium excluding taxes, extra premium, if any and all survival benefits paid earlier. 
                     </td>
                 </tr>
                 <tr>
                     <td>
                     ...
                     <td>
                        Term = 9 years Less than Rs. 75,000 : NIL<br>
Rs. 75,000 and Less than Rs.150,000 : 6 %<br>
Rs. 150,000 and above . : 8 %<br><br>

Term =12 years<br>
Less than Rs. 100,000 : NIL<br>
Rs. 100,000 and Less than Rs. 200,000. : 4 %<br>
Rs. 200,000 and above : 6 %<br><br>

Term =15 years<br>
Less than Rs. 150,000 : NIL<br>
Rs. 150,000 and Less than Rs.300,000 : 3 %<br>
Rs. 300,000 and above : 5 %<br>
