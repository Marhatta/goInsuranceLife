...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "jeevan_tarun.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=jeevan_tarun.php">
...
-->
    ...
    <div class="col-md-12 img-responsive">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left">Here are the full details of Jeevan Tarun plan.Click on pdf to get the details.</marquee>    
                 </div>
                ...
                <div class="col-md-3" style="float:right;margin-top:-15px;margin-right:-60px;">
                 ...
                 <a href="https://www.licindia.in/getattachment/Products/Insurance-Plan/jeevan-tarun/22062016-Tarun.pdf.aspx">Jeevan&nbsp;Tarun&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="pol_text1 wow bounceInLeft">LIC's Jeevan Tarun</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:100px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span class="pol_text1" style="color:whitesmoke;">Dazzling six,Happy mix:<br>Maturity value + Risk cover + Loylty additions + Money back + Extended cover + Auto cover</span>
                  </div>
      ...
      <!--           
            ...
            <div style="margin-right:-60px;">
                 ...
                 <img src="images/jeevan_tarun.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
           ...
           <div class="col-md-12 img-responsive">
                 ...
                 LIC's JEEVAN TARUN is a participating non-linked limited premium payment plan which offers an attractive combination of protection and saving features for children. This plan is specially designed to meet the educational and other needs of growing children through annual Survival Benefit payments from ages 20 to 24 years and Maturity Benefit at the age of 25 years.<br><br>
               Where, Survival Benefit is the annual payment of a fixed percentage of Sum Assured (as defined in the table above) every year starting from policy anniversary coinciding with or following the completion of 20 years of age and thereafter on each of the next 4 policy anniversaries and Maturity Benefit is a fixed percentage of Sum Assured (as defined in the table above) along with vested Simple Reversionary Bonuses and Final Additional Bonus, if any, on maturity.<br><br>

The chosen option shall become a part of the policy contract and no further change in option shall be allowed.<br><br>

In addition, this plan also takes care of liquidity needs through its loan facility.<br><br>

The plan can be purchased by any of the parent or grand parent for a child aged 0 to 12 years.</div>
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight"><strong>On death during the policy term (before commencement of risk): </strong><br>
                  In case of death of the Life Assured, return of premium/s paid excluding taxes, extra premium and rider premium, if any, without interest shall be payable.<br><br>

<Strong>On death during the policy term (after commencement of risk): </Strong><br>
In case of death during the policy term provided all due premiums have been paid Death Benefit, defined as sum of “Sum Assured on Death” and vested Simple Reversionary Bonuses and Final Additional Bonus, if any, shall be payable. Where “Sum Assured on Death” is defined as Higher of 10 times of annualized premium or Absolute amount Assured to be paid on Death i.e. 125% Sum Assured.<br><br>

This Death Benefit shall not be less than 105% of the total premiums paid as on date of death.<br><br>
...
The premiums mentioned above exclude taxes, extra premium and rider premium, if any.
   ...
   <div>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
         n case of Life Assured surviving the stipulated date of maturity, a fixed percentage of Sum Assured shall be payable on maturity for inforce maturing policies.</p><br />
   </div>
   ...
   <div>
    <span style="font-weight:300;font-size:18px;color:background;"> Survival Benefits :
     ...
     <button class="btn btn-warning img-responsive quote2 wow fadeInRight" style="margin-left:500px;margin-top:-20px;">Life is priceless, insurance is affordable <span style="font-size:13px;font-weight:200;">Dan Wilcox</span></button>
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
          A fixed percentage of Sum Assured shall be payable on each policy anniversary coinciding with or immediately following the completion of 20 years of age and thereafter on each of next four policy anniversaries.</p><br />
   </div>
   ...
   <div>
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight">
         The policy shall participate in profits of the Corporation and shall be entitled to receive Simple Reversionary Bonuses declared as per the experience of the Corporation, provided the policy is inforce.<br><br>

Final Additional Bonus may also be declared under the policy in the year when the policy results into a claim either by death or maturity.</p><br />
   </div>
                     

        <span style="font-weight:300;font-size:18px;color:background;">Optional Benefit:
         <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span>
          <button class="btn btn-warning img-responsive quote2 wow fadeInRight" style="margin-left:500px;margin-top:-20px;">Life happens so get life insurance  <span style="font-size:13px;font-weight:200;">Brittany LaRoche</span></button><br><br>
 
 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">LIC’s Premium Waiver Benefit Rider (UIN: 512B204V01), on the life of proposer may be opted for by payment of additional premium. </p>
  </div>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                         75,000 and above ( in multiples of 5000)
                     </td>
                 </tr>
                 <tr>
                     <td>
                 ...
                 <tr>
                     ...
                     <td>
                        75,000 to 1,90,000 - Nil<br>
2,00,000 to 4,90,000 - 2 per thousand SA<br>
