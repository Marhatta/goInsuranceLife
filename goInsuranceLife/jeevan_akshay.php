...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "jeevan_akshay.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=jeevan_akshay.php">
...
<div class="col-md-12">
    ...
    <div class="col-md-2">
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left" class="marquee_text">Here are the full details of the LIC Jeevan Akshay-VI.Click on pdf to get the details.</marquee>    
                 </div>
                ...
                <div class="col-md-3" style="float:right;margin-top:-15px;margin-right:-60px;">
                 ...
                 <a href="https://licindia.in/getattachment/Products/Pension-Plans/jeevan_akshay/151116-LICs-Jeevan-Akshay-VI-PolDoc.pdf.aspx">Jeevan&nbsp;Akshay-VI&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="wow bounceInLeft pol_text1">LIC's Jeevan Akshay-VI</span>
                  ...
                  <div style="position:absolute;font-size:18px;margin-left:40px;margin-top:120px;font-weight:200;" class="wow fadeInUp" data-wow-delay="1s">
                      <span style="color:whitesmoke;" class="pol_text2">Enjoy as well as secure your seven day weekend life..</span>
                  </div>
                 ...
                 <img src="images/pension2.png"  id="pension2_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
           ...
           <div class="col-md-12 img-responsive">
                 ...
                 <div class="col-md-3" style="margin-top:20px;margin-left:-40px;">
                     <span style="font-size:25px;margin-left:50px;color:background;">Secure your<br>
                         <span style="margin-right: -60px;">retired life</span></span><br />
                 ...
                 It is an Immediate Annuity plan, which can be purchased by paying a lump sum amount. The plan provides for annuity payments of a stated amount throughout the life time of the annuitant. Various options are available for the type and mode of payment of annuities.</div>
                 
                  
                 
                
        <div style="margin-top:20px;">  <span style="font-weight:300;font-size:20px;color:background;"> Type of Annuity :
        <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i>
         <button class="btn btn-warning img-responsive wow fadeInRight quote1" style="margin-left:400px;" >Live,love,leave well<span style="font-size:13px;font-weight:200;"> &nbsp;Mario&nbsp;Alban&nbsp;Santos</span></button></span><br /><br />
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
                    1.Annuity payable for life at a uniform rate.<br><br>
                    2.Annuity payable for 5, 10, 15 or 20 years certain and thereafter as long as the annuitant is alive.<br><br>
                    3.Annuity for life with return of purchase price on death of the annuitant.<br><br>
                    4.Annuity payable for life increasing at a simple rate of 3% p.a.Annuity for life with a provision of 50% of the annuity payable to spouse during his/her lifetime on death of the annuitant.<br><br>
                    5.Annuity for life with a provision of 100% of the annuity payable to spouse during his/her lifetime on death of the annuitant.<br><br>
                    6.Annuity for life with a provision of 100% of the annuity payable to spouse during his/ her life time on death of annuitant.<br><br>
                    7.The purchase price will be returned on the death of last survivor.<br><br>
                    You may choose any one. Once chosen, the option cannot be altered.<br><br>
                </p>
            </div>
                     
   <div>
    <span style="font-weight:300;font-size:18px;color:background;">Mode :
    ...
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
        Annuity may be paid either at monthly, quarterly, half yearly or yearly intervals. You may opt any mode of payment of Annuity..</p><br />
   </div>
  ...
  <div>
     ...
     <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
        1.Premium is to be paid in a lump sum.<br><br>
        2.Minimum purchase price :<br>
        Rs.100,000/- for all distribution channels except online.<br>
        Rs.150,000/- for on line sale.<br><br>
        3.No medical examination is required under the plan.<br><br>
        4.No maximum limits for purchase price, annuity etc.<br><br>
        5.Minimum allowed age at entry is 30 years (completed) and Maximum allowed age at entry is 85 years (completed).<br><br>
        6.Age proof necessary.<br></p>
  </div>

  <div>

        <span style="font-weight:300;font-size:18px;color:background;">Service Tax :
         <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span><br>
          
     <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
        Service tax, if any, shall be as per the Service Tax Laws and at the rate of service tax as applicable from time to time.<br><br>
The amount of service tax as per the prevailing rates shall be payable by the policyholder along with the purchase price.</p>
  </div>

<div>
        <span style="font-weight:300;font-size:18px;color:background;">Surrender Value :
         <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span><br><br>
          
     <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
        Surrender shall be allowed after completion of atleast one policy year only for Annuity Option – “Annuity with return of purchase price “under any of the following circumstances.</p>
  </div>

 
<div>
        <span style="font-weight:300;font-size:18px;color:background;">Paid up value :
         <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span><br><br>
          
     <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
        The policy does not acquire any paid-up value.</p>
  </div>

<div>
        <span style="font-weight:300;font-size:18px;color:background;">  A. If the annuitant is diagnosed as suffering from any of the following critical illnesses:
         <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span><br><br>
          
     <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
    1.Cancer of specified severity<br><br>
    2.Myocardial infraction<br><br>
    3.Open Chest CABG<br><br>
    4.Open Heart Replacement or Repair of Heart Valves<br><br>
    5.Kidney Failure requiring regular dialysis<br><br>
    6.Stroke resulting in Permanent Symptoms<br><br>
    7.Major Organ/Bone Marrow Transplant<br><br>
    8.Permanent Paralysis of Limbs<br><br>
    9.Motor Neurone Disease with Permanent Symptoms<br><br>
    10.Multiple Sclerosis with Persisting Symptoms<br><br>
    11.Angioplasty<br><br>
    12.Benign Brain Tumor<br><br>
    13.Blindness<br><br>
    14.Deafness<br><br>
    15.End stage Lung failure<br><br>
    16.End stage liver failure<br><br>
    17.Loss of speech<br><br>
    18.Loss of Limbs<br><br>
    19.Major Head Trauma<br><br>
    20.Primary(Idiopathic)Pulmonary Hypertension<br><br>
    21.Third Degree Burns<br><br></p>
  </div>


  <div>

        <span style="font-weight:300;font-size:18px;color:background;">B. 
         <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span><br><br>
          
     <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">If the annuitant is shifting to another country permanently as evidenced in their visa or citizenship documents. The surrender value payable shall depend on the age (last birthday) of the policyholder at the time of surrender of the policy.For all annuity options other than “Annuity with return of purchase price” surrender shall not be allowed in any case.
...
<div>
     <span style="font-weight:300;font-size:20px;color:background;"> Benefits :
                 <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span><br><br>
<p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">The amount of annuity is assured throughout life of the annuitant.<br><br>
    <span style="font-weight:300;font-size:18px;color:background;">What happens if the annuitant dies? </span>
    <br><br>
<p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
    If the annuitant dies :<br><br>
(i) Under option (i) annuity ceases.<br>
(ii) Under option (ii)<br>
On death during the guaranteed period - annuity is paid to the nominee till the end of the guaranteed period after which the same ceases.<br>
On death after the guaranteed period - annuity ceases.<br>
(iii) Under option (iii) annuity ceases and the purchase price is paid to the nominee.<br>
(iv) Under option (iv) annuity ceases.<br>
(v) Under option (v) annuity ceases and 50% of the annuity is payable to the surviving named spouse during his/her life time. If the spouse predeceases the annuitant, the annuity ceases.<br>
(vi) Under option (vi) annuity ceases and full annuity is payable to the surviving named spouse during his/her life time. If the spouse predeceases the annuitant, the annuity ceases.<br>
(vii) Under option (vii) annuity ceases. Full annuity is payable to the surviving named spouse during his/ her life time and purchase price is paid to the nominee after the death of the spouse. If the spouse predeceases the annuitant, the annuity ceases and purchase price will be paid to the nominee.<br><br>


<span style="font-weight:300;font-size:18px;color:background;">When first installment of annuity payable :</span>
<p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">
First installment of annuity is payable after one month, three months, six months or one year from the date of purchase of annuity depending on the mode chosen is monthly, quarterly, half yearly or yearly respectively.<br>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                         There is no loan facility available under this particular policy.
                     </td>
                 </tr>
