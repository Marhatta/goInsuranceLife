...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "group_credit.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=group_credit.php">
    ...
    <div class="col-md-2">
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left" class="marquee_text">Here are the full details of the Group Credit Life Insurance  Plan.Click on pdf to get the details.</marquee>    
                 </div>
               ...
               <a href="https://www.licindia.in/getattachment/Group-Schemes/Group-Scheme/Sales_Brochure_LIC_GCLI.pdf.aspx">Group&nbsp;Credit&nbsp;Life&nbsp;Insurance&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="wow bounceInLeft pol_text1">LIC's Group Credit Life Insurance Plan</span>
                 ...
                 <img src="images/group_1.jpg"  id="endow_image" class="img-responsive pol_image" style="width:100%;height:420px;margin-left:-30px;">
                 </div>
           <div class="col-md-12 img-responsive">
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                         4,00,000 and above (in multiples of Rs. 10,000/-)
                     </td>
                 </tr>
