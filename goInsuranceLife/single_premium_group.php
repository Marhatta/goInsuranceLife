...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "single_premium_group.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=single_premium_group.php">
...
<div class="col-md-12">
    ...
    <div class="col-md-2">
         ...
         <div class="col-md-2">
             <div style="margin-top:30px;">
                 <a href=".html">  <i class="fa fa-home wow fadeInRight" style="font-size:40px;margin-left:60px;color:#3b5998;;"></i></a>
             </div>
             <div style="margin-top:10px;">
...
-->
     ...
     <div class="col-md-12 img-responsive">
             ...
             <div class="col-md-12" style="margin-top:30px;">
                 ...
                 <div class="col-md-9">
                     <marquee style="color:#999999;" direction="left">Here are the full details of the Single Premium Group Insurance  Plan.Click on pdf to get the details.</marquee>    
                 </div>
               ...
               <a href="https://www.licindia.in/getattachment/Group-Schemes/Group-Scheme/Sales_Brochure_LIC_GCLI.pdf.aspx">Single&nbsp;Premium&nbsp;&nbsp;Insurance&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="pol_text1 wow bounceInLeft">
                     <span style="color:whitesmoke;" class="wow bounceInLeft">LIC's Group Credit Life Insurance Plan</span>
            ...
            -->
               ...
               <div style="margin-right:-60px;">  
                 <img src="images/group2.jpg"  id="endow_image" class="img-responsive pol_image" style="width:1300px;height:420px;margin-left:-30px;">
           ...
           <div class="col-md-12 img-responsive">
                ...
                LIC’s Group Credit Life Insurance is a non–linked, non-participating single premium group
term insurance plan. This plan offers an insurance cover on death of the group member during
the policy term.<br>
...
provider (i.e. Master Policyholder).</div>
                 ...
                 <p style="font-weight:400;text-align: justify;font-size:16px;" class="wow fadeInRight">In case of unfortunate death of a member under a policy during the policy term, a Sum
...
<div>
    <span style="font-weight:300;font-size:18px;color:background;"> SECTION 45 OF THE INSURANCE LAWS (AMENDMENT) ACT, 2015 :
     <i class="fa fa-umbrella wow bounceInRight" style="font-size:30px;color: #009933;"></i></span>
     
    <p style="font-weight:400;text-align:justify;font-size:16px;" class="wow fadeInRight"><br />
        The provisions of Section 45 of the Insurance Laws (Amendment) Act, 2015 shall be as
amended from time to time. The simplified version of this provision is as under:<br>
Provisions regarding policy not being called into question in terms of Section 45 of the
Insurance Laws (Amendment) Act, 2015 are as follows:<br><br>
1. No Policy of Life Insurance shall be called in question on any ground whatsoever after
expiry of 3 yrs from<br>
a. the date of issuance of policy or<br>
b. the date of commencement of risk or<br>
c. the date of revival of policy or<br>
d. the date of rider to the policy<br>
...
which such decision is based.<br><br>
3. Fraud means any of the following acts committed by insured or by his agent, with the
intent to deceive the insurer or to induce the insurer to issue a life insurance policy:<br>
a. The suggestion, as a fact of that which is not true and which the insured does not believe
to be true;<br>
b. The active concealment of a fact by the insured having knowledge or belief of the fact;<br>
c. Any other act fitted to deceive; and <br>
d. Any such act or omission as the law specifically declares to be fraudulent.<br><br>
4. Mere silence is not fraud unless, depending on circumstances of the case, it is the duty of
the insured or his agent keeping silence to speak or silence is in itself equivalent to speak.<br><br><br><br>
...
was no deliberate intention to suppress the fact or that such mis-statement of or suppression
of material fact are within the knowledge of the insurer. Onus of disproving is upon the
policyholder, if alive, or beneficiaries.<br><br>
...
ground and materials on which decision to repudiate the policy of life insurance is based.<br><br>
...
representative or nominee or assignees of insured, within a period of 90 days from the date
of repudiation.<br><br>
...
fact, no life insurance policy would have been issued to the insured.<br><br>
9. The insurer can call for proof of age at any time if he is entitled to do so and no policy
shall be deemed to be called in question merely because the terms of the policy are adjusted
on subsequent proof of age of life insured. So, this Section will not be applicable for
questioning age or adjustment based on proof of age submitted subsequently. </p><br />
   </div>
         ...
         <table class=" table table-responsive table-hover table-striped  wow fadeInLeft" >
             ...
             <tbody>
                 ...
                 <tr>
                     ...
                     <td>
                        Before 6 months prior to the end of policy term
                     </td>
                 </tr>
