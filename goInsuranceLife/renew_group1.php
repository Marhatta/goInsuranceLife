...
if($alertmes2==1)
{
	...
	echo 'window.location.href = "renew_group1.php";';
          ...
          <!-- Modal content-->
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="post" action="addcontact.php?id=renew_group1.php">
...
-->
     ...
     <div class="col-md-12 img-responsive">
            ...
            <div class="col-md-12" style="margin-top:30px;">
               ...
               <a href="https://www.licindia.in/Group-Schemes/Group-Scheme/Sales_Brochure_OYRGTA_I_for_Site">1-Yr&nbsp;Renewable&nbsp;Group&nbsp;Term&nbsp;Assurance&nbsp;Plan&nbsp;pdf</a>
               </div>
             ...
             <div class=" panel panel-body  ">
                 <div style="position:absolute;font-size:30px;margin-left:40px;margin-top:45px;font-weight:300;" class="wow bounceInLeft">
                     <span style="color:whitesmoke;" class="pol_text1 wow bounceInLeft">LIC's New 1 Year Renewable Group Term Assurance Plan-I</span>
 ...
 <!--                
		...
		-->            
           ...
           <div class="col-md-12 img-responsive">
                ...
                LIC’s New One Year Renewal Group Term Assurance Plan - I is a non–
...
<div>
    <span style="font-weight:300;font-size:20px;color:background;"> Salient Features :
...
(iii) Scope of reviewability of premium rates at each Annual Renewal Date (ARD)</p><br />
   </div>
